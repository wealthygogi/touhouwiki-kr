...
<ScenarioStage title="시작">
  <Action>「비신과 파괴신의 긴 하루」</Action>
  <Dialogue speaker="플랑드르" align="left">
...
<ScenarioStage title="노멀 (vs 요리가미 자매)">
...
<ScenarioStage title="이지 & 노멀 (vs 우츠호)">
