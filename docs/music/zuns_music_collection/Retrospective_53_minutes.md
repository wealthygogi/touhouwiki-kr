...
아침 반대 방향은 출근 인파로 정어리 떼처럼 북적이지만, 도쿄행은 한산했다.  
둘에게는 호재였다.  
...
히로시게에서 보이는 이 후지가 훨씬 장엄해 보인다.  
히로시게의 파노라마 뷰로 보면 고층 빌딩도 송전선도 고가철도도 하나도 보이지 않기 때문이다.  

후지를 제쳐 두더라도, 왼편의 해안선만으로도 세계유산으로 열두 번 지정해도 모자랄 만큼 아름답다.  
동해도는 이처럼 아름답다.  
...
신귀 천도가 이루어진 뒤, 많은 사람이 도쿄와 교토를 오가야 할 필요가 생겼다.  
...
동해도는 예전엔 53개의 역참이 있었다는데, 지금은 53분 만에 도착하잖아?  
...
두 사람이 유쿄토역을 출발한 지, 벌써 36분 정도가 지났다.  

창밖의 풍경은 우타가와 히로시게가 보며 걸었을 동해도 그 자체였다.  
끝없이 끝없이 아름답다. 하늘과 바다, 후지산. 오십삼 개의 역참.  
...
정부는 영봉 후지 바로 아래에 구멍을 뚫는다는 경건치 못한 사태만큼은 피했다.  

묘유동해도는 후지를 피해 수해 아래를 달리고 있다.  
...
「그야 박식하니까.  
뭐든지 세 수도를 이어 이름도 케이토(繋都) 신칸센으로 하고 싶었다더라.」  
...
아스팔트로 굳혀진 지령의 죄도 시효를 맞아, 도쿄의 길 곳곳에 균열이 생기고 있었다.  
...
도쿄에는 에도 시대부터  
‘투식회’라 불린, 죽음도 두려워하지 않는 먹기 대회가 있었다.  
...
꿈과 현실을 구분할 수 없듯이 인간과 나비를 구분할 수 없듯이,  
